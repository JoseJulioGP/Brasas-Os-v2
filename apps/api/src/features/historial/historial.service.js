...
class HistorialService {
  ...
  async registrar({ usuario_id, local_id, tipo_accion, entidad, entidad_id, descripcion }) {
    try {
      return await historialRepository.insert({ usuario_id, local_id: local_id || null, entidad, entidad_id, accion: tipo_accion || null, detalle: descripcion ? { descripcion } : null });
    } catch (err) {
